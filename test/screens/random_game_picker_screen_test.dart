...
import 'package:boardpocket/presentation/screens/random_game_picker_screen.dart';
...
Widget createTestWidget({required GameProvider gameProvider}) {
  return MultiProvider(
    ...
    child: MaterialApp(
      ...
      home: const RandomGamePickerScreen(),
    ),
  );
}

void main() {
  group('RandomGamePickerScreen - Basic Rendering', () {
